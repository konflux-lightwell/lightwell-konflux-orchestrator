...
class JavaEcosystem:
    ...
    namespace = NAMESPACE
    # Java's shared component means reuse must be resolved through source-matching
    # import PipelineRuns, not the generic component-digest Snapshot search.
